      ...
      <section style={{ background: 'linear-gradient(180deg, #031122 0%, #071C34 50%, #005DB8 100%)', color: '#FFFFFF', padding: '5.5rem 0 4.5rem 0', textAlign: 'center' }}>
        <div className="container">
          ...
          <p style={{ color: 'var(--text-on-dark-muted)', maxWidth: '820px', margin: '0 auto', fontSize: '1.15rem', lineHeight: 1.6 }}>
            Guided by Director & Founder Ustaadh Naasir Akinbolanle Jamiu from Connecticut, USA, our faculty of certified Huffaz, Islamic Law scholars, and experienced educators provides authentic 1-on-1 Qur'anic and Islamic education worldwide.
          </p>
        </div>
      </section>
